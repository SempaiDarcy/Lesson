...
// // - что должно быть в консоли?
// console.log(students[0].friends===copyStudents[0].friends)
// // - что должно быть в консоли?

//4*. Полная (глубокая) копия массива students (map)
// let deepCopyStudents = [...students]
let deepCopyStudents = students.map(el=>el.friends?{...el,friends:[...el.friends]}:el);
// let deepCopyStudents = students.map(el=>({...el,friends: {...el.friends}}))
...
console.log(students[0].friends===deepCopyStudents[0].friends)
